...
dataset_guise = DoubleLineFormalDataset(100000, total_output=1, line_num=2)
# dataset_guise[0]
...
model = Model("FindPoints", dataset_guise, 64,
...
def criterion(y_hat, y, meta):
    ...
    predicted_box[predicted_label] = y[predicted_label]
