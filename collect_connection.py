...
if __name__ == "__main__":
    ...
    # 此處修改路徑
    path = "line_sg_test/circuit444_2_10.json"
    with open(path, "r") as file:
        ...
        data = [
            [[0.05310596525669098, 0.44958990812301636], [0.0714285746216774, 0.4502131938934326]],
            [
                [0.07296573370695114, 0.45291662216186523],
                [0.08410254865884781, 0.45258039236068726],
            ],
        ]
        # data = [
        #     [[0.01, 0.01], [0.74, 0.53]],
